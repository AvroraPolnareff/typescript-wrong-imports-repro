...
export function FSharpMap__ComputeHashCode(this$) {
    ...
    try {
        while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
            const activePatternResult5641 = enumerator["System.Collections.Generic.IEnumerator`1.get_Current"]();
            res = (combineHash(res, structuralHash(activePatternResult5641[0])) | 0);
            res = (combineHash(res, structuralHash(activePatternResult5641[1])) | 0);
        }
    }
    finally {
        enumerator.Dispose();
